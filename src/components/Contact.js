...
export default function Contact() {
  return (
    <div name='contact' className='h-screen w-full bg-gray-bg-one text-white'>
        ...
        <div>
          ...
          <div className='flex justify-center items-center'>
            <form action='https://getform.io/f/56207652-1b0e-4f2e-b67c-bea54f610b5b'
              ...
              />
              <button
                className='text-white bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-900 px-6 py-3 my-8 mx-auto flex
